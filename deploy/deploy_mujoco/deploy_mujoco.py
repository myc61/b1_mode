...
if __name__ == "__main__":
    ...
    joint_start = 7
    joint_end = joint_start + len(default_angles)
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0:
                ...
                base_z = d.qpos[2]
                measured_heights = np.zeros(num_height, dtype=np.float32)  # 平地时全0
                heights = np.clip(base_z - 0.5 - measured_heights, -1, 1) * height_measurements
                ...
                #print("action:", action*action_scale)
